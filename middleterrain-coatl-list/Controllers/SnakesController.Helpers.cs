...
namespace middleterraincoatllist.Controllers
{
	public partial class SnakesController
	{
		...
		public static List<CompanyInfo> ReadRecordInterval(IDbConnection conn, IDbTransaction tran, string SortingField, string sort, int start, int length)
		{
			...
			using (IDataReader reader = cmd.ExecuteReader ()) {
				...
				while (reader.Read ()) {
					...
					c.Description = (string)reader ["description".ToUpper()];
					res.Add (c);
				}
				return res;
			}
			...
			try {
				using (IDbConnection conn = GetConnection()) {
					...
					for (int i = 0; i < 1000; ++i)
					{
						...
						ci.Id = i;
						ci.Name = "google" + i.ToString();
						ci.Url = "www.gooogle.com/"+ i.ToString();
						ci.Description = "autogenerated"+ i.ToString();
						InsertRecord (conn, null, ci);
					}
					*/
				}
				using (IDbConnection conn = GetConnection()) {
		...
		public static void DatabaseCreateStructure (IDbConnection conn, IDbTransaction tran)
		{
			try {
				using (IDbCommand cmd = conn.CreateCommand ()) {
					cmd.CommandText = "CREATE TABLE MY_PRODUCTS (MyId INTEGER, name VARCHAR, url VARCHAR, description VARCHAR)";
		...
		public static void InsertRecord (IDbConnection conn, IDbTransaction tran, CompanyInfo r)
		{
			try {
				using (IDbCommand cmd = conn.CreateCommand ()) {
					cmd.CommandText = "INSERT INTO MY_PRODUCTS (MyId, name, url, description) VALUES ({pMyId}, $pName, ?pUrl, @pDescription)";
					// MyId
					...
					description.ParameterName = "pDescription";
					description.DbType = DbType.Int32;
